...
class CalculatorViewModel: ViewModel() {
    ...
    fun onAction(actions: CalculationActions) {
        when (actions) {
            is CalculationActions.Number -> enterNumber(actions.number)
            is CalculationActions.Decimal -> enterDecimal()
            is CalculationActions.Clear -> state = CalculatorState()
            is CalculationActions.Operation -> enterOperation(actions.operation)
            is CalculationActions.Calculate -> performCalculation()
            is CalculationActions.Delete -> performDeletion()
        }
    }
